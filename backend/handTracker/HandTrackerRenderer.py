    ...
    def get_coords(self, hands):
         ...
         if self.show_xyz:
            for hand in hands:
                ...
                cv2.putText(self.frame, f"Y:{hand.xyz[1]/10:3.0f} cm", (x0+10, y0+45), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 2)
                cv2.putText(self.frame, f"Z:{hand.xyz[2]/10:3.0f} cm", (x0+10, y0+70), cv2.FONT_HERSHEY_PLAIN, 1, (0,0,255), 2)
            # print(f"X:{hand.xyz[0]/10:3.0f} cm, Y:{hand.xyz[1]/10:3.0f} cm, Z:{hand.xyz[2]/10:3.0f} cm", flush=True)
                # return (f"X:{hand.xyz[0]/10:3.0f} cm, Y:{hand.xyz[1]/10:3.0f} cm, Z:{hand.xyz[2]/10:3.0f} cm")   
